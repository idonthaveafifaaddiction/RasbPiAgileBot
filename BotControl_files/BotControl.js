...
$(function ()
{
    ...
    var $message = $('#message');
    var $coordsContainer = $('#cords');

    ws.onopen = function(){
      $message.append('<p>Connection Open</p>');
        ws.send("Hello, world");
    };

    ws.onmessage = function(ev){
      $message.append('<p>Recieved Message</p>');
    ...
    {
        var coords = ("Thumbstick Input <br />x: " + x + " y: " + y);

        $coordsContainer.html(coords);
